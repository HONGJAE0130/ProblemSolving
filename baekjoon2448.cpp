...
void print(char **arr, int w, int h); int main(void) {
	char **arr; int w, i, h, j;
	scanf("%d", &h); arr = (char**)malloc(sizeof(*arr) * h);
	w = h * 2 + 1; for (i = 0; i < h; ++i) {
	...
	print(arr, w, h); free(arr); return 0;
}
